...
// 페이지별로 하위 행정 단위를 목록으로 노출 (읍면동 개별 페이지는 만들지 않음 = 도어웨이 방지)
// 구 단위는 기존 페이지가 있으면 링크로 연결
// ============================================================================
...
export const adminDivisions = {
  ...
  "/daejeon/yuseong-gu/": { groups: [{ label: "주요 행정동", items: S(["진잠동","학하동","원신흥동","상대동","온천1동","온천2동","노은1동","노은2동","노은3동","신성동","전민동","구즉동","관평동","관저1동","관저2동"]) }] },
  "/daejeon/seo-gu/": { groups: [{ label: "주요 행정동", items: S(["둔산1동","둔산2동","둔산3동","탄방동","월평1동","월평2동","월평3동","만년동","갈마1동","갈마2동","괴정동","가장동","도마1동","도마2동","정림동","복수동","관저1동","관저2동","가수원동","내동","변동","용문동"]) }] },
  "/daejeon/jung-gu/": { groups: [{ label: "주요 행정동", items: S(["은행선화동","목동","중촌동","대흥동","문창동","석교동","대사동","부사동","용두동","오류동","태평1동","태평2동","유천1동","유천2동","문화1동","문화2동","산성동"]) }] },
  "/daejeon/dong-gu/": { groups: [{ label: "주요 행정동", items: S(["중앙동","신인동","효동","판암1동","판암2동","용운동","대동","자양동","가양1동","가양2동","성남동","홍도동","삼성동","대청동","산내동","용전동"]) }] },
  "/daejeon/daedeok-gu/": { groups: [{ label: "주요 행정동", items: S(["오정동","대화동","회덕동","비래동","송촌동","중리동","법1동","법2동","신탄진동","석봉동","덕암동","목상동"]) }] },

  // ── 세종 (특별자치시) — 동 + 읍·면 ─────────────────────────────────────────
  "/sejong/": {
    note: "세종은 자치구가 없는 특별자치시로, 신도시 동 지역과 읍·면으로 구성됩니다.",
    groups: [
      { label: "행정동(신도시)", items: S(["한솔동","새롬동","한별동","도담동","아름동","종촌동","고운동","보람동","대평동","소담동","다정동","나성동","어진동","해밀동","반곡동"]) },
  ...
  "/cheonan/seobuk-gu/": { groups: [
    { label: "행정동", items: S(["성정1동","성정2동","쌍용1동","쌍용2동","쌍용3동","백석동","불당1동","불당2동","부성1동","부성2동"]) },
    { label: "읍·면", items: S(["성환읍","성거읍","직산읍","입장면"]) },
  ] },
  "/cheonan/dongnam-gu/": { groups: [
    { label: "행정동", items: S(["중앙동","문성동","원성1동","원성2동","봉명동","일봉동","신방동","청룡동","신안동"]) },
  ...
  "/chungbuk/cheongju/sangdang-gu/": { groups: [
    { label: "행정동", items: S(["중앙동","성안동","탑대성동","영운동","금천동","용담명암산성동","용암1동","용암2동"]) },
    { label: "읍·면", items: S(["낭성면","미원면","가덕면","남일면","문의면"]) },
  ] },
  "/chungbuk/cheongju/seowon-gu/": { groups: [
    { label: "행정동", items: S(["사직1동","사직2동","사창동","모충동","산남동","분평동","수곡1동","수곡2동","성화개신죽림동"]) },
    { label: "읍·면", items: S(["남이면","현도면"]) },
  ] },
  "/chungbuk/cheongju/heungdeok-gu/": { groups: [
    { label: "행정동", items: S(["운천신봉동","복대1동","복대2동","가경동","봉명1동","봉명2송정동","강서1동","강서2동"]) },
    { label: "읍·면", items: S(["오송읍","강내면","옥산면"]) },
  ] },
  "/chungbuk/cheongju/cheongwon-gu/": { groups: [
    { label: "행정동", items: S(["우암동","내덕1동","내덕2동","율량사천동"]) },
    { label: "읍·면", items: S(["오창읍","내수읍","북이면"]) },
  ] },

  // ── 충남 시·군 (읍·면·동) ──────────────────────────────────────────────────
  "/chungnam/asan/": { groups: [
    { label: "행정동", items: S(["온양1동","온양2동","온양3동","온양4동","온양5동","온양6동"]) },
  ...
  "/chungnam/boryeong/": { groups: [
    { label: "행정동", items: S(["대천1동","대천2동","대천3동","대천4동","대천5동"]) },
  ...
  "/chungbuk/chungju/": { groups: [
    { label: "주요 행정동", items: S(["성내충인동","교현안림동","용산동","지현동","문화동","호암직동동","달천동","봉방동","칠금금릉동","연수동","목행용탄동"]) },
    { label: "읍·면", items: S(["주덕읍","살미면","수안보면","대소원면","신니면","노은면","앙성면","중앙탑면","금가면","동량면","산척면","엄정면","소태면"]) },
  ] },
  "/chungbuk/jecheon/": { groups: [
    { label: "주요 행정동", items: S(["교동","의림동","화산동","남현동","영서동","용두동","청전동","신백동"]) },
