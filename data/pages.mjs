...
export const home = {
  ...
  coreZones: [
    { label: "대전 둔산·탄방", url: "/chungcheong/life/daejeon-dunsan/" },
    { label: "대전 유성·봉명", url: "/chungcheong/life/daejeon-yuseong/" },
    { label: "세종 나성·새롬", url: "/sejong/life/naseong-saerom/" },
    { label: "세종 조치원", url: "/sejong/life/jochiwon/" },
    { label: "천안 불당·쌍용", url: "/cheonan/life/buldang-ssangyong/" },
    { label: "천안 두정·성정", url: "/cheonan/life/dujeong-seongjeong/" },
    { label: "천안 신부·터미널", url: "/cheonan/life/sinbu-terminal/" },
    { label: "아산 배방·탕정", url: "/chungnam/asan/" },
  ],
  chungnam: [
